...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            item_number = input("Please type the menu item number: ")
            ...
            if item_number.isdigit():
                ...
                if item_number in menu_items.keys():
                    ...
                    menu_selection = menu_items[item_number]

                    # Ask the customer for the quantity of the menu item
                    quantity = input(f"How many of {menu_selection['Item name']} would you like? ")
                    ...
                    print(f"Added {quantity} x {menu_selection['Item name']} to your order.")
                else:
